...
fluidPage(
  ...
  titlePanel("Subset your data into equal sample sizes which are best representative of each complete set of data.  Use subsets for plotting purposes."),
  
  sidebarPanel(
    
    tags$head(
      tags$style(HTML('#run_stats{background-color:#9999FF; text-color:black; border-color:black; font-weight:bold}'))
    ),
    ...
    selectInput('average_setting', 'Type of average', c("Mean","Median"), selected = "Mean"),
